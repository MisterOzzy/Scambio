...
namespace Scambio.Web.Helpers
{
    public static class ImageHelper
    {
        public static Stream CropImage(byte[] content, int x, int y, int width, int height)
        {
        ...
        public static Stream CropImage(Stream content, int x, int y, int width, int height)
        {
            ...
            using (Bitmap sourceBitmap = new Bitmap(content))
            {
                ...
                using (Bitmap newBitMap = new Bitmap(cropRect.Width, cropRect.Height))
                {
                    using (Graphics g = Graphics.FromImage(newBitMap))
                    {
                        ...
                        return GetBitmapStream(newBitMap);
                    }
                }
            }
        }

        public static Stream GetBitmapStream(Bitmap source)
        {
